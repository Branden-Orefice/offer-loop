...
import AnalyticsConversionCard from "@/features/home-page/analytics-conversion-card";
import AnalyticsLineChart from "@/features/home-page/analytics-line-chart";

const AnalyticsChart = () => {
  return (
    <div className="mt-6 w-3/4 rounded-2xl bg-(--card-background) p-4 sm:p-6">
